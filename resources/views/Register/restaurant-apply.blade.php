                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="/application-restaurant" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="mincart" id=""
                                        placeholder="Minimum Cart Price" value="0">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Delivery Price</label>
                                    <input type="text" class="form-control form-control-user" name="serveprice" id=""
                                        placeholder="Delivery Price" value="0">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Expected Delivery Time</label>
                                    <input type="text" class="form-control form-control-user" name="servetime" id=""
                                        placeholder="Expected Delivery Time" value="10">
                                </div>  
