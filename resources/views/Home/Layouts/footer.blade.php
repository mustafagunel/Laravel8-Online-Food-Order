<div class="content">
    <div class="footer mt-5 pt-4 " style="background-color:#efefef">
        <div class="conteiner">
            <div class="row d-flex justify-content-between">
                <div class="d-flex col-sm-5 offset-sm-1 pd-1" style="font-size:small; color:red" >
                    <div class="col-4">
                        <ul style="list-style:none;">
                            <a href="/login" style="text-decoration:none"><li>Kullanıcı Giriş</li></a>
                            <a href="/restaurant-login" style="text-decoration:none"><li>Restaurant Giriş</li></a>
                ...
                <div class="social-media d-flex justify-content-between col-sm-2 col-6">
